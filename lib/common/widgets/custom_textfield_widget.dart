...
class CustomTextFieldState extends State<CustomTextField> {
  ...
  void onFocusChanged(){
    ...
    FocusScope.of(rootNavigatorKey.currentContext!).requestFocus(widget.focusNode);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        widget.showTitle ? Text(widget.titleText, style: fontRegular.copyWith(fontSize: Dimensions.fontSizeLarge,fontWeight: FontWeight.w600)) : const SizedBox(),
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            label: widget.showLabelText ? Text.rich(TextSpan(children: [
              ...
              //   TextSpan(text: widget.fromUpdateProfile ? ' (${'phone_number_can_not_be_edited'.tr})' : ' (${'non_changeable'.tr})', style: fontRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).colorScheme.error)),
            ...
            prefixIcon: widget.isPhone ? SizedBox(width: 95, child: Row(children: [
              ...
              child: Image.asset(widget.prefixImage!, height: 25, width: 25, fit: BoxFit.scaleDown),
