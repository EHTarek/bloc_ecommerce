...
class _CodePickerWidgetState extends State<CodePickerWidget> {
  ...
  void initState() {
    ...
    if(widget.countryList != null && widget.countryList!.isNotEmpty){
      ...
      favoriteElements = elements!.where((e) => widget.favorite!.firstWhere((f) => e.code!.toUpperCase() == f.toUpperCase() || e.dialCode == f || e.name!.toUpperCase() == f.toUpperCase()) != null).toList();
    }
