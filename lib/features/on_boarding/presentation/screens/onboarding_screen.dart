...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void showingOnboarding() {
    Future.wait([
      prefs.setBoolValue(keyName: PreferencesKey.kOnboardingStatus, value: true),
    ]);
  }
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: Column(
                      children: [
                        // Image.asset(
                        //   contents.elementAt(index).image,
                        ...
                        Text(
                          contents.elementAt(index).title,
